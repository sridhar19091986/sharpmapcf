...
namespace SharpMap.Rendering.Thematics
{
	...
	public class GradientTheme : ITheme
	{
...
#if !CFBuild //Slightly different in CF - can't specify family, only actual font name.
			style.Font = new System.Drawing.Font(min.Font.FontFamily,FontSize,min.Font.Style);
#else
            style.Font = new System.Drawing.Font(min.Font.Name, FontSize, min.Font.Style);
#endif
...
#else
            style.Offset = new System.Drawing.Point((int)InterpolateFloat(min.Offset.X, max.Offset.X, value), (int)InterpolateFloat(min.Offset.Y, max.Offset.Y, value));
#endif
			return style;
		}
        ...
        {
#if !CFBuild //In CF, only solid color pens anyway (i think)
...
#if !CFBuild //None of these are in CF, Lost Functionality
		...
		private System.Drawing.Color InterpolateColor(System.Drawing.Color minCol, System.Drawing.Color maxCol, double attr)
		{
			...
			else
			{
				...
				if (b > 255) b = 255;
				if (a > 255) a = 255;
#if !CFBuild //FromArgb needs an int32 in CF, Not sure if I did this right.
