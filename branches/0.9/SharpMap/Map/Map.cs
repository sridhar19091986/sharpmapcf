...
namespace SharpMap
{
	...
	public class Map : IDisposable
	{
		...
		public Map(System.Drawing.Size size)
		{
			...
			this._MinimumZoom = 0;
#if !CFBuild //Matrices don't exist in CF Lost functionality.
...
#if !CFBuild //pageunit is always pixel in CF, PageUnit doesn't exist in CF.
...
#if !CFBuild //Contains not in String in CF I think this can be safely substituted.
				if (l.LayerName.Contains(layername))
#else
                if (l.LayerName.IndexOf(layername) != -1)
#endif
	            yield return l;
		}
        ...
        /// <param name="p">Point in world coordinates</param>
        /// <returns>Point in image coordinates</returns>
        public System.Drawing.Point WorldToImage(SharpMap.Geometries.Point p)
        {
            return Utilities.Transform.WorldtoMap(p, this);
        }
#endif
        ...
        /// <param name="p">Point in image coordinates</param>
        /// <returns>Point in world coordinates</returns>
        public SharpMap.Geometries.Point ImageToWorld(System.Drawing.Point p)
        {
            return Utilities.Transform.MapToWorld(p, this);
        }
#endif
...
#if !CFBuild //No matrix in CF Lost Functionality
