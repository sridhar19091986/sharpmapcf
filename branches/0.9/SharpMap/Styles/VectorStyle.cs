...
namespace SharpMap.Styles
{
	...
	public class VectorStyle : Style
	{
...
#if !CFBuild //no Brushes collection in CF , Should be equivalent in full framework.
			this.Fill = System.Drawing.Brushes.Black;
#else
            this.Fill = new System.Drawing.SolidBrush(System.Drawing.Color.Black);
#endif
...
#else
        private System.Drawing.Point _SymbolOffset;
        ...
        /// The symbol offset is scaled with the <see cref="SymbolScale"/> property and refers to the offset af <see cref="SymbolScale"/>=1.0.
        /// </remarks>
        public System.Drawing.Point SymbolOffset
        {
            get { return _SymbolOffset; }
            set { _SymbolOffset = value; }
        }
