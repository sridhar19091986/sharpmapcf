...
namespace SharpMap.Rendering
{
	...
	public class VectorRenderer {
#if !CFBuild //v2.0 Bitmap does not have a FromStream method. Probably equivalent.
		private static System.Drawing.Bitmap defaultsymbol =
            (System.Drawing.Bitmap)System.Drawing.Bitmap.FromStream(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("SharpMap.Styles.DefaultSymbol.png"));
#else
        private static System.Drawing.Bitmap defaultsymbol =
            new System.Drawing.Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("SharpMap.Styles.DefaultSymbol.png"));
#endif
		/// <summary>
		...
		public static void DrawLineString(System.Drawing.Graphics g, Geometries.LineString line, System.Drawing.Pen pen, SharpMap.Map map)
		{
			...
			{
#if !CFBuild //Use DrawLines instead of DrawPath. Possible loss of functionality, but may be equivalent.
				System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath();
				gp.AddLines(line.TransformToImage(map));
				g.DrawPath(pen, gp);
#else
                g.DrawLines(pen, line.TransformToImage(map));
#endif
			}
		}
		...
		public static void DrawPolygon(System.Drawing.Graphics g, SharpMap.Geometries.Polygon pol, System.Drawing.Brush brush, System.Drawing.Pen pen, bool clip, SharpMap.Map map)
		{
            ...
            {
#if !CFBuild //Use FillPolygon and DrawPolygon instead of FillPath and DrawPath Potential problem with interior holes.
...
#else
                //Use a graphics path instead of DrawPolygon. DrawPolygon has a problem with several interior holes
                //Probably true, restrict the data to stuff with no holes (only draw the exterior ring)
                //Draw the exterior polygon only.
                System.Drawing.Point[] Pts = pol.ExteriorRing.TransformToImage(map);
                g.FillPolygon(brush, Pts);
                if (pen != null){
                    //by javi;
                    g.DrawPolygon(pen, Pts);

                    //DrawPolygonGdi(g, pen, Pts);
                }
#endif
            }
		}

#if !CFBuild //Label rendering - no label rotation (that I know of) in CF. Also, use Point instead of PointF Lost Functionality
		/// <summary>
        ...
        /// <param name="text">Text to render</param>
        /// <param name="map">Map reference</param>
        public static void DrawLabel(System.Drawing.Graphics g, System.Drawing.Point LabelPoint, System.Drawing.Point Offset, System.Drawing.Font font, System.Drawing.Color forecolor, System.Drawing.Brush backcolor, System.Drawing.Pen halo, float rotation, string text, SharpMap.Map map)
        {
            System.Drawing.SizeF fontSize = g.MeasureString(text, font); //Calculate the size of the text
            LabelPoint.X += Offset.X; LabelPoint.Y += Offset.Y; //add label offset

            System.Drawing.SolidBrush SB = (System.Drawing.SolidBrush)backcolor;

            if (backcolor != null && SB.Color != System.Drawing.Color.Transparent)
                g.FillRectangle(backcolor, LabelPoint.X, LabelPoint.Y, (int)(fontSize.Width * 0.74f + 1), (int)(fontSize.Height * 0.74f));
...
#if !CFBuild //Ignore this since it isn't used at the moment.
		/// <summary>
...
#if !CFBuild  //Change to use Point instead of PointF. Also, no rotation available. Lost Functionality.
        /// <summary>
		...
		/// <param name="rotation">Symbol rotation in degrees</param>
		/// <param name="map">Map reference</param>
		public static void DrawPoint(System.Drawing.Graphics g, SharpMap.Geometries.Point point,
                                    System.Drawing.Bitmap symbol, float symbolscale, 
                                    System.Drawing.Point offset, float rotation, SharpMap.Map map)
		{
			if (point == null)
				return;
			if (symbol == null) //We have no point style - Use a default symbol
			...
			System.Drawing.Point pp = SharpMap.Utilities.Transform.WorldtoMap(point, map);
			
            if (symbolscale == 1f)
                g.DrawImage(symbol, (int)(pp.X - symbol.Width / 2 + offset.X), (int)(pp.Y - symbol.Height / 2 + offset.Y));
            else
            {
                float width = symbol.Width * symbolscale;
                float height = symbol.Height * symbolscale;
                //Not sure this will work right.
                System.Drawing.Rectangle R = new System.Drawing.Rectangle(0, 0, (int)width, (int)height);

                g.DrawImage(symbol, (int)((int)pp.X - width / 2 + offset.X * symbolscale), 
                            (int)((int)pp.Y - height / 2 + offset.Y * symbolscale), 
...
#if !CFBuild  //by javi; Change to use Point instead of PointF. 
		/// <summary>
        ...
        /// <param name="rotation">Symbol rotation in degrees</param>
        /// <param name="map">Map reference</param>
        public static void DrawMultiPoint(System.Drawing.Graphics g, Geometries.MultiPoint points,
                                          System.Drawing.Bitmap symbol, float symbolscale,
                                            System.Drawing.Point offset, float rotation, SharpMap.Map map)
        {
            for (int i = 0; i < points.Points.Count; i++)
